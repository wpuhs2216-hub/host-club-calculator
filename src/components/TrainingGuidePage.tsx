...
function PricingSection() {
  return (
    <div className="flex flex-col gap-3">
      ...
      <Card title="正規">
        <p className="text-xs text-gray-400 mb-2">21:00入店で料金が変わる</p>
        <div className="grid grid-cols-3 gap-1 text-xs text-center mb-2">
          <span className="text-gray-400"></span>
          <span className="font-bold text-[var(--accent-color)]">〜20:59入店</span>
          <span className="font-bold text-[var(--gold-color)]">21:00〜入店</span>
        </div>
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <Card title="半額の計算方法">
        ...
        <Row label="ショット系の半額" value="¥3,000 → ¥1,500" />
      </Card>
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <Card title="特殊・タワー">
        ...
        <Row label="テキーラスタンド（12）" value="¥39,000" />
        <Row label="テキーラスタンド（16）" value="¥48,000" />
        <Row label="テキーラスタンドVIP" value="¥72,000" />
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <Quiz questions={[
        ...
        { q: 'Q15: 正規、21:00入店、24:00会計、同伴あり、オーダー無し。合計は？', a: 'セット¥5,000+延長¥6,000+指名¥3,000+同伴¥3,000+T.C¥500=¥17,500 → TAX¥6,125 → ¥23,700' },
        { q: 'Q16: 新規（セット¥1,000）、20:00入店、21:00会計、ショット1杯（半額）。合計は？', a: 'セット¥1,000+指名¥1,000+ショット半額¥1,500=¥3,500 → TAX¥1,225 → ¥4,800' },
